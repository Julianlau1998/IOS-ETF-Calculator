...
class ViewController: UIViewController, GADFullScreenContentDelegate {
    ...
    private let banner: GADBannerView = {
        ...
        banner.adUnitID = "ca-app-pub-1006221991146598/8822021232"
    ...
    override func viewDidLoad() {
        ...
        guard let url = URL(string: "https://etf-calculator.netlify.app/") else {
            return
        }
    ...
    @objc func loadInterstitial() {
        let request = GADRequest()
            GADInterstitialAd.load(
              withAdUnitID: "ca-app-pub-1006221991146598/6195857894", request: request
            ) { (ad, error) in
              if let error = error {
